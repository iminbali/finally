-- FinAlly schema. All tables idempotent; lazy-initialized on first connection.
-- All tables include user_id (default 'default') to keep the door open for multi-user later.
